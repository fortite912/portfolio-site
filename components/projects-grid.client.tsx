          ...
          {CATS.map((c) => {
            ...
            return (
              <button
                ...
                style={{
                  background:
                    active === c ? "rgba(226,105,60,0.1)" : "rgba(255,255,255,0.03)",
                  border: `1px solid ${
                    active === c ? "rgba(226,105,60,0.2)" : "rgba(255,255,255,0.06)"
                  }`,
                  color:
              ...
              >
                ...
                <span
                  ...
                  style={{
                    background: active === c ? "rgba(226,105,60,0.15)" : "rgba(255,255,255,0.06)",
